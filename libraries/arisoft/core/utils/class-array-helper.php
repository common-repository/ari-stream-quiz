...
class Array_Helper {
    public static function get_value( $arr, $key, $default = null, $filter = null ) {
        $val = $default;
    ...
    public static function to_int( $array, $min = null, $max = null, $unique = true ) {
        if ( ! is_array( $array ) ) {
            $array = array( $array );
        }
    ...
    public static function sort_assoc( $data, $key, $dir = 'asc', $cmp = 'string' ) {
    ...
    public static function ensure_array( $val ) {
        if ( ! is_array( $val ) ) {
            $val = array( $val );
        }
    ...
    public static function to_flat_array( $params, $delimiter = '$$', $prefix = '' ) {
        $result = array();
    ...
    public static function to_complex_array( $params, $delimiter = '$$' ) {
        $result = array();
    ...
    public static function &value_by_path( $path, &$src, $separator = '.', $default = null ) {
    ...
    public static function get_unique_override_parameters( $src, $override ) {
        $unique_params = array();
        if ( is_null( $override ) ) {
            $override = array();
        }
